...
interface IntangibleAssetsUnderDevelopmentNoteProps {
    data: AssetAgeingRow[];
}
...
export const IntangibleAssetsUnderDevelopmentNote: React.FC<IntangibleAssetsUnderDevelopmentNoteProps> = ({ data }) => {
    return (
        <div className="overflow-x-auto">
             <h4 className="font-semibold text-gray-300 mb-2">Ageing of Intangible Assets under Development</h4>
            <table className="min-w-full text-sm">
                ...
                <tbody className="divide-y divide-gray-600">
                    ...
                    {data.length === 0 && <tr><td colSpan={5} className="p-4 text-center text-xs text-gray-500">No assets under development to report.</td></tr>}
                </tbody>
            </table>
        </div>
    );
