...
export const NotesToAccounts: React.FC<ReportProps> = ({ allData }) => {
    ...
    const notesMap: Record<string, { title: string; component: React.ReactNode }> = {
        ...
        revenue: { title: 'Revenue from Operations', component: <RevenueFromOpsNote data={scheduleData.revenueFromOps} allData={allData} noteId="revenue" /> },
        otherIncome: { title: 'Other Income', component: <OtherIncomeNote data={scheduleData.otherIncome} allData={allData} noteId="otherIncome" /> },
        ...
        finance: { title: 'Finance Costs', component: <FinanceCostsNote data={scheduleData.financeCosts} allData={allData} noteId="finance" /> },
