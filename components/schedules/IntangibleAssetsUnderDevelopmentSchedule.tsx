...
interface IntangibleAssetsUnderDevelopmentScheduleProps {
    data: AssetAgeingRow[];
    onUpdate: (data: AssetAgeingRow[]) => void;
    isFinalized: boolean;
}

export const IntangibleAssetsUnderDevelopmentSchedule: React.FC<IntangibleAssetsUnderDevelopmentScheduleProps> = ({ data, onUpdate, isFinalized }) => {
    ...
    return (
        <div className="space-y-4">
            <h3 className="text-lg font-semibold text-white">Intangible Assets under Development - Ageing</h3>
